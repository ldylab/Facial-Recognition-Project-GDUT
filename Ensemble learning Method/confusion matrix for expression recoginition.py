...
for clf, label in zip([clf1, clf2, clf3, clf4, sclf],
    ...
    i = 0
    # 绘制没有归一化的混淆矩阵
    titles_options = [("Confusion matrix, without normalization (NMF+{name})".format(name=label), None),
...
for clf, label in zip([clf1, clf2, clf3, clf4, sclf],
    ...
    i = 0
    # 绘制没有归一化的混淆矩阵
    titles_options = [("Confusion matrix, without normalization (PCA+{name})".format(name=label), None),
...
for clf, label in zip([clf1, clf2, clf3, clf4, sclf],
    ...
    i = 0
    # 绘制没有归一化的混淆矩阵
    titles_options = [("Confusion matrix, without normalization (LDA+{name})".format(name=label), None),
